...
Public Class cryTimeworkSummarize
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "cryTimeworkSummarize.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TimeAttendance.cryTimeworkSummarize.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcryTimeworkSummarize
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As cryTimeworkSummarize = New cryTimeworkSummarize()
        rpt.Site = Me.Site
        Return rpt
    End Function
