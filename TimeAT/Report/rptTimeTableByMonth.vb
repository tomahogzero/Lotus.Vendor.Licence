...
Public Class rptTimeTableByMonth
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptTimeTableByMonth.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TimeAttendance.rptTimeTableByMonth.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptTimeTableByMonth
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptTimeTableByMonth = New rptTimeTableByMonth()
        rpt.Site = Me.Site
        Return rpt
    End Function
