...
Public Class cryRPT_MaxOT
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TimeAttendance.cryRPT_MaxOT.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcryRPT_MaxOT
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As cryRPT_MaxOT = New cryRPT_MaxOT()
        rpt.Site = Me.Site
        Return rpt
    End Function
