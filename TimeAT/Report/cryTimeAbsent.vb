...
Public Class cryTimeAbsent
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TimeAttendance.cryTimeAbsent.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcryTimeAbsent
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As cryTimeAbsent = New cryTimeAbsent()
        rpt.Site = Me.Site
        Return rpt
    End Function
