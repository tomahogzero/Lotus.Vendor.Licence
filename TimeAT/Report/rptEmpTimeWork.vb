...
Public Class rptEmpTimeWork
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TimeAttendance.rptEmpTimeWork.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptEmpTimeWork
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptEmpTimeWork = New rptEmpTimeWork()
        rpt.Site = Me.Site
        Return rpt
    End Function
