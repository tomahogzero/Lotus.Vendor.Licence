...
Public Class cryRPT_OTreport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TimeAttendance.cryRPT_OTreport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcryRPT_OTreport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As cryRPT_OTreport = New cryRPT_OTreport()
        rpt.Site = Me.Site
        Return rpt
    End Function
