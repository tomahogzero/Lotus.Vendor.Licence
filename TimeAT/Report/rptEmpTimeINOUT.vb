...
Public Class rptEmpTimeINOUT
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TimeAttendance.rptEmpTimeINOUT.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptEmpTimeINOUT
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptEmpTimeINOUT = New rptEmpTimeINOUT()
        rpt.Site = Me.Site
        Return rpt
    End Function
