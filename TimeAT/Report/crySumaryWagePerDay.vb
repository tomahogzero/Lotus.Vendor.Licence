...
Public Class crySumaryWagePerDay
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "crySumaryWagePerDay.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TimeAttendance.crySumaryWagePerDay.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrySumaryWagePerDay
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crySumaryWagePerDay = New crySumaryWagePerDay()
        rpt.Site = Me.Site
        Return rpt
    End Function
