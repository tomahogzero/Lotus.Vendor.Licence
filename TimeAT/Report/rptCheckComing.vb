...
Public Class rptCheckComing
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TimeAttendance.rptCheckComing.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptCheckComing
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCheckComing = New rptCheckComing()
        rpt.Site = Me.Site
        Return rpt
    End Function
