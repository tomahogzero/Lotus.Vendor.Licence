...
Public Class cryCountAbsent
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TimeAttendance.cryCountAbsent.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcryCountAbsent
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As cryCountAbsent = New cryCountAbsent()
        rpt.Site = Me.Site
        Return rpt
    End Function
