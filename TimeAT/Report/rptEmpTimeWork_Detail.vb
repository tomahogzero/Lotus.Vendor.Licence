...
Public Class rptEmpTimeWork_Detail
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptEmpTimeWork_Detail.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TimeAttendance.rptEmpTimeWork_Detail.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptEmpTimeWork_Detail
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptEmpTimeWork_Detail = New rptEmpTimeWork_Detail()
        rpt.Site = Me.Site
        Return rpt
    End Function
