...
Public Class cryTimeAbsLate
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TimeAttendance.cryTimeAbsLate.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcryTimeAbsLate
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As cryTimeAbsLate = New cryTimeAbsLate()
        rpt.Site = Me.Site
        Return rpt
    End Function
