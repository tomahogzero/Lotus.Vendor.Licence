...
Public Class frmKaGroupUse
    ...
    Private Sub LoadEmp()
        ...
        strSQL &= ",Lname, " &
                ...
                " Where WorkStatus = 'W' and Isnull(UseKaDate,0) = 0 "
    ...
    Private Sub btnAdd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAdd.Click
        ...
        Try
            ...
            '    strSQL = "Update Emp Set UseKaDate = 1 " &
    ...
    Private Sub btnRemove_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnRemove.Click
        ...
        Try
            ...
            '    strSQL = "Update Emp Set UseKaDate = 0 " &
    ...
    '        spcon.SplitterPosition = 106
    '    End If

    'End Sub

    'Private Sub btnHide_cal_Click(sender As Object, e As EventArgs)
    '    If btnHide_cal.Text = "ซ่อนค้นหา" Then
    '        btnHide_cal.Text = "แสดงค้นหา"
    '        spcon_cal.SplitterPosition = 0
    '    Else
    '        btnHide_cal.Text = "ซ่อนค้นหา"
    '        spcon_cal.SplitterPosition = 132
    '    End If
    'End Sub

    Private Sub frmKaGroupUse_ResizeEnd(sender As Object, e As EventArgs) Handles Me.ResizeEnd
