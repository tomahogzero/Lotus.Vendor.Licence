...
Module ModSystem
    ...
    Public fWorkSpecial As frmWorkSpecial  ' config กำหนดวันทำงานพิเศษ
    ...
    Public Structure setPermission
        ...
        ' ReadOnly
        Public Shared PermissionTimeAtt_ReadOnly As Boolean = True  ' เมนู ประมวลผลเวลาทำงาน
        Public Shared ManageTime_ReadOnly As Boolean = True   ' เมนู เพิ่ม / แก้ไขเวลาทำงาน
