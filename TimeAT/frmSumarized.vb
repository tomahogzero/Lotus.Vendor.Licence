...
Public Class frmSumarized
    ...
    Private Sub CreateColumn()
        With lstSumaried
            ...
            .Columns.Add("ÃËÑÊ¾¹§.", 77, HorizontalAlignment.Center)
            .Columns.Add("ª×èÍ - Ê¡ØÅ", 250, HorizontalAlignment.Left)
            .Columns.Add("ÃËÑÊá¼¹¡", 70, HorizontalAlignment.Center)
            .Columns.Add("à§Ô¹à´×Í¹", 70, HorizontalAlignment.Right)
            ...
            For I = 0 To Ds.Tables("Data").Rows.Count - 1
                .Columns.Add(Ds.Tables("Data").Rows(I).Item("Code").ToString & "(ß)", 70, HorizontalAlignment.Right)
            Next
            Ds.Clear()
            .Columns.Add("", 20, HorizontalAlignment.Center)
            .Columns.Add("Abs(ÇÑ¹)", 55, HorizontalAlignment.Right)
            .Columns.Add("Late(ªÁ.)", 55, HorizontalAlignment.Right)
            .Columns.Add("", 20, HorizontalAlignment.Center)
            .Columns.Add("Abs(ß)", 60, HorizontalAlignment.Right)
            .Columns.Add("Late(ß)", 60, HorizontalAlignment.Right)
        End With
    ...
    Private Sub LoadData()
        ...
        With Ds.Tables("Data")
            ...
            For I = 0 To .Rows.Count - 1
                ...
                Dim J As Integer
                For J = 1 To MaxAw
                    lstSumaried.Items(I).SubItems.Add(Format(LoadAllowance(.Rows(I).Item("Code"), Replace(lstSumaried.Columns(J + 8).Text.Trim, "(ß)", "")), "#,##0.00"))
                Next
