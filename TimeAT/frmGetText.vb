...
Public Class frmGetText
    ...
    Private Sub btnGetText_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnGetText.Click
        ...
        If Dir(FullFileName).Trim = "" Then
            'MsgBox("ไม่พบไฟล์ชื่อนี้กรุณาเลือกใหม่", MsgBoxStyle.Information, Me.Text)
            MsgManager.ShowDialog(Me, "frmGetTextRS", Me.Text, "FileName_NotFound", MessageBoxIcon.Information)
            Exit Sub
        End If


        lblStatus.Text = "กำลัง นำเข้าข้อมูล กรุณารอสักครู่ ....."
        ...
        'MessageBox.Show("นำเข้าเรียบร้อยแล้ว", )
        If chkAutoSave.Checked = True Then
            lblStatus.Text = "กำลังบันทีกข้อมูล กรุณารอสักครู่ .............."
            ...
            Application.DoEvents()
        Else
            'MsgBox("นำเข้า เรียบร้อยแล้ว", MsgBoxStyle.Information, Me.Text)
            MsgManager.ShowDialog(Me, "frmGetTextRS", Me.Text, "Import_Success", MessageBoxIcon.Information)
            lblStatus.Text = "นำเข้าข้อมูลเรียบร้อยแล้ว   กรุณาบันทึกข้อมูลด้วย"
            lblStatus.ForeColor = Color.Green
            Application.DoEvents()
        End If
        lblStatus.Text = "-"
...
Err:
    ...
    Private Sub GetType1(ByVal FullFileName As String)
        ...
        Do While Sr.Peek() >= 0
            ...
            row += 1
            lblStatus.Text = " นำเข้าข้อมูล ที่ " & row
            Application.DoEvents()
    ...
    Private Sub GetType12(ByVal FullFileName As String)
        ...
        Do While Sr.Peek() >= 0
            ' ต้องเขียน อ่านจากหลังมาหน้า เพราะว่า รหัส + ช่องว่าง 12 + วันที่ และเวลา
            '53-2-131            201211230711F1001'
            line = Sr.ReadLine()
            ...
            If EmpCodeIsExist(Code.Trim) = False Then
                CodeErr = "{ไม่พบรหัสพนง.}" & Code.Trim
                StatusError &= CodeErr
            End If
    ...
    Private Sub GetType13_CKC(ByVal FullFileName As String)
        '1      (2 เวลา)       3               4       6               6           7           (8 รหัสพนักงาน)                           9
    ...
    Private Sub btnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSave.Click
        ...
        Try
            ...
            For I = 0 To lstListFile.Items.Count - 1
                ...
                lblStatus.Text = "บันทึกข้อมูล " & I & "/" & lstListFile.Items.Count
                Application.DoEvents()
            Next
